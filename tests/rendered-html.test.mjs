...
test("keeps content and rendering systems modular", async () => {
  ...
  assert.match(experience, /maker\.dataset\.makerState = "after"/);
  ...
  assert.match(experience, /creationTitleAnchorRef/);
  assert.match(experience, /titleAnchorRect\.width \/ Math\.max\(maker\.offsetWidth, 1\)/);
  assert.match(experience, /titleAnchorRect\.left - makerBaseLeft/);
  assert.match(experience, /titleAnchorRect\.bottom - makerBaseBottom/);
  assert.match(experience, /titleAnchor\.style\.opacity = aligned \? "1" : "0"/);
  ...
  assert.match(experience, /transmission-content/);
  ...
  assert.match(styles, /fixed-making-prefix\{[^}]*text-align:left[^}]*text-indent:0/);
  assert.doesNotMatch(styles, /fixed-making-prefix\{[^}]*text-indent:-/);
